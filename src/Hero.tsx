  ...
  return (
    <div id="home" style={{ minHeight: '100vh', background: '#fff', letterSpacing: '-0.02em', fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{
        ...
        {/* Left — DSC Logo */}
        <a href="#home" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#fff', textDecoration: 'none', pointerEvents: 'auto' }}>
          <img
            src="assets/creative-ai/club logo.png"
            alt="DSC Logo"
      ...
      {/* ===== Hero Section ===== */}
      <section className="relative w-full overflow-hidden h-screen" style={{ height: '100dvh', backgroundImage: "url('assets/creative-ai/1782459062237-ezremove.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
