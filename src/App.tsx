...
export default function App() {
  ...
  const renderLoop = () => {
    // Handle interactive wheel scroll vs continuous auto-scroll
    if (targetProgress.current !== null) {
      const diff = targetProgress.current - progress.current;
      progress.current += diff * 0.1;
      // Resume slow auto-scroll seamlessly if no scroll is happening
  ...
  return (
    <div 
      ...
      onWheel={(e) => {
        // Track horizontal scrolling to move cards
